...
import com.hdfandroid.adapter.TransactionListAdapter
...
class OverviewFragment : BaseFragment(), ViewTreeObserver.OnScrollChangedListener {
    ...
    private fun loadTransactions() = GlobalScope.launch(Dispatchers.Default) {
        val jsonResult = multiWallet.getTransactions(0, MAX_TRANSACTIONS, Hdflibwallet.TxFilterRegular, true)
    ...
    private fun isOffline(): Boolean {
        ...
        val syncAnyways = multiWallet.readBoolConfigValueForKey(Hdflibwallet.SyncOnCellularConfigKey, false)
