...
import com.hdfandroid.activities.RESTORE_WALLET_REQUEST_CODE
import com.hdfandroid.activities.RestoreWalletActivity
import com.hdfandroid.adapter.PopupDivider
import com.hdfandroid.adapter.PopupItem
import com.hdfandroid.adapter.PopupUtil
import com.hdfandroid.adapter.WalletsAdapter
import com.hdfandroid.data.Constants
import com.hdfandroid.dialog.CreateWatchOnlyWallet
import com.hdfandroid.dialog.FullScreenBottomSheetDialog
import com.hdfandroid.dialog.InfoDialog
import com.hdfandroid.dialog.RequestNameDialog
                                ...
                                RequestNameDialog(R.string.wallet_name, "", true) { newName ->
                                    try {
                                        if (multiWallet.walletNameExists(newName)) {
                                            return@RequestNameDialog Exception(Hdflibwallet.ErrExist)
                                        }
