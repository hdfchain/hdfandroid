...
class ChangePassUtil(private val fragmentActivity: FragmentActivity, val walletID: Long?) {
            ...
            if (pass != null) {
                ...
                GlobalScope.launch(Dispatchers.Default) {
                    ...
                    try {
                        ...
                        passwordPinDialogFragment.tabIndex = if (passPromptUtil!!.passType == Hdflibwallet.PassphraseTypePass) {
                            0
                        } else 1
    ...
    private fun changePassphrase(dialog: FullScreenBottomSheetDialog, newPassphrase: String, passphraseType: Int) = GlobalScope.launch(Dispatchers.IO) {
        ...
        if (walletID == null) {
            ...
            try {
                ...
                if (multiWallet.readBoolConfigValueForKey(walletID.toString() + Hdflibwallet.UseBiometricConfigKey, Constants.DEF_USE_FINGERPRINT)) {
    ...
    private fun showError(passType: Int) {
        val err = if (passType == Hdflibwallet.PassphraseTypePass) {
