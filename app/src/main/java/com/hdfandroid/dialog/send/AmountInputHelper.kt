...
import com.hdfandroid.util.GetExchangeRate
...
class AmountInputHelper(private val layout: LinearLayout, private val scrollToBottom: () -> Unit) : TextWatcher, View.OnClickListener, GetExchangeRate.ExchangeRateCallback {
    ...
    private fun fetchExchangeRate() {
        ...
        val currencyConversion = multiWallet.readInt32ConfigValueForKey(Hdflibwallet.CurrencyConversionConfigKey, Constants.DEF_CURRENCY_CONVERSION)
        ...
        val userAgent = multiWallet.readStringConfigValueForKey(Hdflibwallet.UserAgentConfigKey)
    ...
    fun setAmountDCR(dcr: Long) = setAmountDCR(Hdflibwallet.amountCoin(dcr))
