...
class WalletSettings : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (wallet.isWatchingOnlyWallet) {
            ...
            useFingerprint = SwitchPreference(this, walletID.toString() + Hdflibwallet.UseBiometricConfigKey, spendable_fingerprint) { newValue ->
        ...
        val incomingNotificationsKey = walletID.toString() + Hdflibwallet.IncomingTxNotificationsConfigKey
        ...
        try {
            ...
            if (e.message == Hdflibwallet.ErrInvalidPassphrase) {
                val errMessage = when (wallet.privatePassphraseType) {
                    Hdflibwallet.PassphraseTypePin -> R.string.invalid_pin
