...
import com.hdfandroid.adapter.SuggestionsTextAdapter
...
import com.hdfandroid.view.SeedEditTextLayout
import com.hdfandroid.view.util.SeedEditTextHelper
...
class RestoreWalletActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_restore.setOnClickListener {
            val seedValid = Hdflibwallet.verifySeed(enteredSeeds)
    ...
    private fun loadSeedSuggestions() = GlobalScope.launch(Dispatchers.IO) {
        val seedWords = Hdflibwallet.AlternatingWords.split("\n")
